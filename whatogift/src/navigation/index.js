    ...
    return(
        <AppTab.Navigator activeColor={Colors.white} inactiveColor={Colors.light_blue} barStyle={{backgroundColor:Colors.ocean}}>
            ...
            <AppTab.Screen name='giftsTab' component={GiftsStack}
                options={{ tabBarLabel: 'Gifts', tabBarIcon: ({color}) => (<MaterialCommunityIcons name='gift' color={color}size={28} />) }} />
            <AppTab.Screen name='favoriteTab' component={FavoriteStack}
                options={{ tabBarLabel: 'Favorite', tabBarIcon: ({color}) => (<MaterialIcons name='favorite' color={color} size={28} />) }} />
            <AppTab.Screen name='profileTab' component={ProfileStack}
                options={{ tabBarLabel: 'Profile', tabBarIcon: ({color}) => (<MaterialCommunityIcons name='account' color={color} size={28} />) }} />
        </AppTab.Navigator>
    )
}
